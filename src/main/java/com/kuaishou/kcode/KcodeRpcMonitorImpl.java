...
//            throw new ArrayIndexOutOfBoundsException("prepareTime="+prepareTime);
            throw new ArrayIndexOutOfBoundsException(""+SplitMinuteThread.maxBisectionTimes+" "+SplitMinuteThread.maxFindTimes+" T="+PrepareMultiThreadManager.THREAD_NUMBER+ " prepare="+prepareTime+" DWS="+DiskReadThread.DiskRead_waitBuffer + " SWD="+SplitMinuteThread.SplitMinute_waitBuffer + " SWM="+SplitMinuteThread.SplitMinute_waitBa);
