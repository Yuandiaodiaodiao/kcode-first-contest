...
//            throw new ArrayIndexOutOfBoundsException("prepareTime="+prepareTime);
            throw new ArrayIndexOutOfBoundsException("prepareTime="+prepareTime+"DiskRead wait "+DiskReadThread.DiskRead_waitBuffer + "SplitWait="+SplitMinuteThread.SplitMinute_waitBuffer + " SplitWaitba="+SplitMinuteThread.SplitMinute_waitBa);
